...
<div class="container">
	<div class="row cartao-principal">
		<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3" style="margin-top: 50px; margin-bottom: 40px;" >
					...
					<div class="card-content">
						...
						<div class="input-group">
							...
							<div class="form-group label-floating has-roxo">
								...
								<input  name="password_atual" type="password" class="form-control error" value="{{ $senha_padrao }}"/>
							</div>
						</div>
